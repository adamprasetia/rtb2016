...
class Export extends MY_Controller {
	...
	public function execute(){		
		...
		if($this->form_validation->run()===false){
			...
			$active_sheet->setCellValue('J1', 'Facebook');
			$active_sheet->setCellValue('K1', 'Twitter');
			$active_sheet->setCellValue('L1', 'Instagram');
			...
			foreach($result as $r){
				...
				$active_sheet->setCellValue('J'.$i, $r->fb);
				$active_sheet->setCellValue('K'.$i, $r->tw);
				$active_sheet->setCellValue('L'.$i, $r->ins);
